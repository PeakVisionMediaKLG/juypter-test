...
def digits_plot():
    ...
    print('>>>',pca.components_[0, :].reshape(8, 8))
    plot_embedding(X_pca, "Principal Components projection of the digits")
    plt.figure()
    plt.title("First Principal Component "+str(pca.components_[0, :].shape))
    #~ plt.title("First Principal Component")
    #~ plt.matshow(pca.components_[0, :].reshape(8, 8), cmap="gray")
    plt.matshow(pca.components_[0, :].reshape(8, 8), cmap=plt.cm.binary)
    plt.axis('off')
    plt.figure()
