""" 
Modul, dass die Klasse CalendarClock implementiert.
"""
...
class CalendarClock(Clock, Calendar):
    """ 
        Die Klasse CalendarClock implementiert eine Uhr mit integrierter Kalenderfunktion.
        Die Klasse erbt sowohl von der Klasse Clock als auch von der Klasse Calendar
    """
    ...
    def __init__(self,day, month, year, hour, minute, second):
        ...
        aufgerufen.
        Zur Initialisierung des Kalenders wird der Konstruktor der Calendar-Klasse
        aufgerufen.

        CalendarClock enthält dann die vereinigten Attribute der
        Clock- und Calendar-Klasse:
    ...
    def __str__(self):
        """
        Erzeugt die Stringdarstellung eines CalendarClock-Objektes
        """
